...
<html>
    ...
    <body>
        <nav class="top-bar expanded" data-topbar role="navigation">
            <ul class="marque-area large-3 medium-4 columns">
                <li class="name">
                   <h1><a href=""><a href=""><?= $this->Html->link(__('tp1'), '/'); ?><?php // echo " - " . $this->fetch('marque');   ?></a></h1></li>
            </ul>
            <div class="top-bar-section">
                <ul class="right">
                    ...
                    <li><?= $this->Html->link('Arabe', ['action' => 'changeLang', 'ar_MA'], ['escape' => false])?></li>

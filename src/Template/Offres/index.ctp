    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('voiture_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $offre->has('voiture') ? $this->Html->link($offre->voiture->marque, ['controller' => 'Voitures', 'action' => 'view', $offre->voiture->slug]) : '' ?></td>
                <td><?= h($offre->name) ?></td>

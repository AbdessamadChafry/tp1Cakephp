...
return [
     ...
     *      /.htaccess
     *      /webroot/.htaccess
     *   And unoffre the baseUrl key below.
    ...
    'Datasources' => [
        'default' => [
             ...
             * MySQL on MAMP uses port 8889, MAMP users will want to unoffre
            ...
            /*
             * During development, if using MySQL < 5.6, unoffreing the
